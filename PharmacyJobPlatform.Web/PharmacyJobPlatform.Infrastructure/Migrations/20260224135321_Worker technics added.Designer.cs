...
namespace PharmacyJobPlatform.Infrastructure.Migrations
{
    ...
    [Migration("20260224135321_Worker technics added")]
    partial class Workertechnicsadded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PharmacyJobPlatform.Domain.Entities.ProfileComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PharmacyJobPlatform.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<int?>("CrossSellingSkillLevel")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("DermocosmeticKnowledgeLevel")
                        .HasColumnType("int");

                    b.Property<int?>("DrugKnowledgeLevel")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("PharmacyPrograms")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int?>("PrescriptionControlLevel")
                        .HasColumnType("int");

                    b.Property<int?>("PrescriptionPreparationLevel")
                        .HasColumnType("int");

                    b.Property<string>("ProfileImagePath")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("ReportControlLevel")
                        .HasColumnType("int");

                    b.Property<int>("RoleId")
                        .HasColumnType("int");

                    b.Property<int?>("SutKnowledgeLevel")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PharmacyJobPlatform.Domain.Entities.UserRating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PharmacyJobPlatform.Domain.Entities.ProfileComment", b =>
                {
                    b.HasOne("PharmacyJobPlatform.Domain.Entities.User", "AuthorUser")
                        .WithMany("CommentsWritten")
                        .HasForeignKey("AuthorUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PharmacyJobPlatform.Domain.Entities.ProfileComment", "ParentComment")
                        .WithMany("Replies")
                        .HasForeignKey("ParentCommentId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("PharmacyJobPlatform.Domain.Entities.User", "ProfileUser")
            ...
            modelBuilder.Entity("PharmacyJobPlatform.Domain.Entities.UserRating", b =>
                {
                    b.HasOne("PharmacyJobPlatform.Domain.Entities.User", "RatedUser")
                        .WithMany("RatingsReceived")
                        .HasForeignKey("RatedUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PharmacyJobPlatform.Domain.Entities.User", "Rater")
