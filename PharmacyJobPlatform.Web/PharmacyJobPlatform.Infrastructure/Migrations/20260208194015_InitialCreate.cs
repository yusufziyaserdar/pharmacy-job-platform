        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ConversationRequests_Users_FromUserId",
                        column: x => x.FromUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ConversationRequests_Users_ToUserId",
                        column: x => x.ToUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PharmacyOwnerId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobPosts_Addresses_AddressId",
                        column: x => x.AddressId,
                        principalTable: "Addresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_JobPosts_Users_PharmacyOwnerId",
                        column: x => x.PharmacyOwnerId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConversationRequests_FromUserId",
                table: "ConversationRequests",
                column: "FromUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ConversationRequests_ToUserId",
                table: "ConversationRequests",
                column: "ToUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobPosts_AddressId",
                table: "JobPosts",
                column: "AddressId");

            migrationBuilder.CreateIndex(
                name: "IX_JobPosts_PharmacyOwnerId",
                table: "JobPosts",
                column: "PharmacyOwnerId");
